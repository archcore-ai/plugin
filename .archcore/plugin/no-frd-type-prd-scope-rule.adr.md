...
- The scope rule lives in `skills/plan/references/product-flow.md` and `skills/plan/references/feature-flow.md` at their PRD steps, with the compression note in the feature flow's Step 2.
...
- The behavior side of the same boundary is governed by the spec admission gate recorded in `spec-single-narrative-ears-bcp14.adr`.
